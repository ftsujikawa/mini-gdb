...
all: tdb target leak_target thread_target fork_target
...
fork_target: fork_target.c
	$(CC) -g fork_target.c -o fork_target

clean:
	rm -f tdb target leak_target thread_target fork_target *.o \
